...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** Controllers
		'loginController': '/AngularController/loginController.js?v=1.1',
		'zoneController': '/AngularController/zoneController.js?v=1.1',
		'countryController': '/AngularController/countryController.js?v=1.1',
        ...
        'chatCtrl': '/AngularController/chatCtrl.js',
    ...
    modules: [{
        ...
        name: 'ngTable',
        files: ['../JS/ng-table.min.js', '../CSS/ng-table.min.css']
    }, {
        name: 'ui.mask',
...
app.constant('AUTH_EVENTS', {
    ...
    notAuthonticated: 'auto-not-authenticated',
    notAuthorised: 'auto-not-authorised',
